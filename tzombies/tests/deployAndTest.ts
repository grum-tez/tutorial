import { get_account, set_quiet, expect_to_fail } from "@completium/experiment-ts"
import { Tzombies, add_for_all } from "./bindings/tzombies"
import { Permits } from "./bindings/permits"
import { Zombie_market } from "./bindings/market"
...
let market: Zombie_market = new Zombie_market()
